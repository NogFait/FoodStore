...
const ProductoList = ({ productos, categorias, onEdit, onDelete, onView}: ProductoListProps) => {
  return (
        ...
        <table className="w-full">
          <thead className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-bold uppercase tracking-wider">Categoria</th>
