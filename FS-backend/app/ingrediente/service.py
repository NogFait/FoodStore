...
class IngredienteService:
    ...
    def list(self, skip: int = 0, limit: int = 20, es_alergeno: Optional[bool] = None) -> list[Ingrediente]:
        with IngredienteUnitOfWork(self._session) as uow:
...
def update_ingrediente(session: Session, ingrediente_id: int, data: IngredienteUpdate) -> Ingrediente:
    service = IngredienteService(session)
